...
export type Material = 'papel-couche-250g' | 'papel-glitter' | 'papel-texturizado' | 'papel-decorativo'
...
export const products: Product[] = [
  {
    ...
    materials: ['papel-couche-250g'],
    sizes: ['15cm', '20cm', '25cm'],
    description: 'Topo elegante em papel couché 250g com letras cursivas douradas. Perfeito para casamentos modernos e clássicos.',
    tags: ['casamento', 'gold', 'clássico', 'papel premium'],
    isBestseller: true,
    rating: 4.9,
    reviewCount: 142,
  },
  {
    ...
    category: 'casamento',
    images: [
      'https://placehold.co/600x700?text=Topo+boho+flores+silvestres+papel texturizado+natural+casamento+rustico+bege',
      'https://placehold.co/600x700?text=Topo+boho+detalhe+flores+secas+textura+natural+premium',
    ],
    materials: ['papel-texturizado'],
    sizes: ['18cm', '22cm'],
    description: 'Design boho em papel texturizado com flores silvestres. Acabamento rústico e natural.',
    tags: ['boho', 'flores', 'papel texturizado', 'rústico'],
    isNew: true,
    rating: 4.8,
    reviewCount: 67,
  },
  {
    ...
    images: [
      'https://placehold.co/600x700?text=Topo+aniversario+neon+cor+rosa+papel premium+colorido+festa+moderno',
      'https://placehold.co/600x700?text=Topo+neon+detalhe+letras+brilhantes+fundo+escuro',
    ],
    materials: ['papel-couche-250g'],
    sizes: ['12cm', '16cm', '20cm'],
    description: 'Topo colorido em papel glitter e papéis decorativos. Ideal para festas vibrantes e comemorações.',
  ...
  },
  {
    ...
    materials: ['papel-couche-250g', 'papel-glitter'],
    sizes: ['10cm', '14cm'],
  ...
  },
  {
    ...
    materials: ['papel-couche-250g'],
    sizes: ['12cm', '16cm'],
    description: 'Design clean e moderno para primeira comunhão. Cruz em papel premium com acabamento dourado.',
  ...
  },
  {
    ...
    materials: ['papel-couche-250g', 'papel-texturizado'],
  ...
  },
  {
    ...
    materials: ['papel-decorativo', 'papel-couche-250g'],
    sizes: ['10cm', '14cm'],
...
export const customOrders: CustomOrder[] = [
  {
    ...
    aiVariants: [
      'https://placehold.co/300x300?text=Variante+IA+1+topo+personalizado+papel premium+pastel+cursivo',
      'https://placehold.co/300x300?text=Variante+IA+2+topo+personalizado+papel texturizado+dourado+moderno',
